...
- `mod_2D5_2Ac4`: All pairwise interactions for all input variables. (`mod_2Ac4`)
...
```{r resampling}
set.seed(1493)
enet_folds <- vfold_cv(df_regr, v = 5, repeats = 5)
...
- The model performances from "all pairwise interactions" (right grids) have better performances compared to the "all continuous pairwise interactions" (left grids).  
