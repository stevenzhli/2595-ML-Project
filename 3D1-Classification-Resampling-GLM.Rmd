...
- Since from EDA we know the class distribution is skewed (low event probability). Both accuracy and ROC AUC may not properly reflect model performance. Thus I opt to use them as reference, and rely on mean log loss as the metric to select best model.  
- Thus the best model is `mod_3D3_3A2` with continuous variables input additive.  
