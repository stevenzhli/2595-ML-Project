...
sprintf("MLE estimated σ: %.3f", sigma(mod_2Ac3))
...
- For the best model identified using WAIC `mod_2B3_2Ac3`:
  - The posterior mode of σ from the Bayesian model is around 0.296 (blue dashed line).
  - The corresponding MLE estimated of σ is 0.283 (blue dotted line).
  - The MLE underestimated σ: there is 94.2% chance σ is greater than the MLE estimate, judging from the posterior samples.  
  - Though because the uncertainty interval is small, this does not mean the MLE estimation of σ is too bad.  
