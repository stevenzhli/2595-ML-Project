...
- Based on WAIC, the three models really do not have much performance differences.  
...
```{r Uncertainty, out.width=400, fig.width=4, fig.asp=1}
...
- The MLE estimated coefficients are plotted using purple diamonds. We see the default priors used slightly constrained the coefficients.  
...
- The correlation of coefficients are from the correlation of corresponding input terms as in EDA.  
