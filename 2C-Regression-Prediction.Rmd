...
This set of inputs is associated with the top 2 most significant continuous inputs. 
...
This set of inputs are selected aiming to examine how the categorical input of customer affects the ability for the most significant continuous input to predict.  
...
This set of inputs involves the most significant linear continuous input (`xb_07`) and the nonlinear continuous input with most magnitude (`xa_08`). I hope to visualize how the two inputs affect the response, at different `region` categories. 
